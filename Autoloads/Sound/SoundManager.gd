...
func play_sound(audio:AudioStream, vol:float=0.0, loop:bool=false, pitch:float=1.0) -> AudioStreamPlayer:
...
func play_music(audio:AudioStream, fade:float=1.0, vol:float=0.0, loop:bool=true, pitch:float=1.0) -> AudioStreamPlayer:
